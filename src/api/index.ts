...
import { RequestBody, LoginDTO, AuthResponse, ResponseData, RegisterDTO, ProfileResponse, UserDTO, ArticleResponse, ArticleDTO, CommentResponse, CommentDTO } from './models';
...
// auth
export const login = (body: RequestBody<'user', LoginDTO>): Promise<ResponseData<'user', AuthResponse>> => request.post('/users/login', body)

export const register = (body: RequestBody<'user', RegisterDTO>): Promise<ResponseData<'user', AuthResponse>> => request.post('/users', body)
